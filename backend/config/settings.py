...
SECRET_KEY = 'django-insecure-#561)(f8_=$8m!y38ypz4g_h9vad66p(9h&omgme2na523&m4x'
...
# Configuración de seguridad - Mantener secreto en producción
SECRET_KEY = 'clave-secreta-aqui'  # En producción, usar variables de entorno

# Configuración de modo depuración - Desactivar en producción
...
# URL principal para el enrutamiento
ROOT_URLCONF = 'config.urls'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',  # En producción, usar PostgreSQL
>>>>>>> 40eab90 (Actualización del backend Django con modelos para usuarios, productos, carrito, pedidos y analíticas)
